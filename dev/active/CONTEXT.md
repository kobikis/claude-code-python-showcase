...
### Pydantic v2 (CRITICAL — breaking changes from v1)
...
### SQLAlchemy 2.0 Async (required imports)

```python
# Always import func explicitly — not re-exported from sqlalchemy top-level in 2.0
...
count = result.scalar()             # count queries
```

### Optional Auth Dependency Pattern
...
### Immutable Service Updates

```python
# ✅ CORRECT — pass only changed fields, let SQLAlchemy track
